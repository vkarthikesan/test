...
class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleConstraintViolation(RepositoryConstraintViolationException ex, WebRequest request) {

        String message = ex.getMessage();

        if(ex.getErrors() != null) {
            List<ObjectError> allErrors = ex.getErrors().getAllErrors();
