...
import com.dharbor.set.fusion.dynamicentityservice.model.Document;
...
public interface DocumentRepository extends JpaRepository<Document, Long>{
    ...
    List<Document> findByUserIdAndCreatedDateLessThanAndIsVisibleOrderByCreatedDateDesc(
    ...
    Collection<Document> findByDmsId(
             @Param("dmsId") @RequestParam("dmsId") String dmsId
    );

    @RestResource(path="findByUserIdAndTitleAndDeleted")
    List<Document> findByUserIdAndCreatedDateLessThanAndDocumentMetadataTitleContainingAndDeletedOrderByCreatedDateDesc(
             @Param("userId") @RequestParam("userId") String userId,
             @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) @Param("createdDate") @RequestParam("createdDate") Date createdDate,
    ...
    Collection<Document> findByUserIdAndCreatedDateLessThanAndDeletedOrderByCreatedDateDesc(
             @Param("userId") @RequestParam("userId") String userId,
             @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) @Param("createdDate") @RequestParam("createdDate") Date createdDate,
             @Param("deleted") @RequestParam("deleted") Boolean deleted
    );

    Collection<Document> findByUserId(
             @Param("userId") @RequestParam("userId") String userId
    );
